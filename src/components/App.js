...
class App extends Component {
  ...
  enterGame = (event) => {
    ...
    var setDoc = db.collection('wagers').doc(wager).set(data);
    this.setState({
      enter: true,
      ...
      <div>
        {
          !this.state.enter ? (
            <div className="App">
              ...
              <div>
                <button value={first} onClick={this.enterGame}>Knicks vs Warriors</button>
              </div>
              <div>
                <button value={second} onClick={this.enterGame}>Thunder vs Nets</button>
              </div>
